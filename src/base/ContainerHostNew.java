...
public class ContainerHostNew {
     ...
     * The vm list.
     */
    private final List<? extends ContainerVmNew> vmList = new ArrayList<>();
    /**
     * The vm list.
     */
     ...
     */
    private final List<ContainerVmNew> vmsMigratingIn = new ArrayList<>();
    /**
    ...
    public double updateContainerVmsProcessing(double currentTime) {
        ...
        for (ContainerVmNew containerVm : getVmList()) {
     ...
     */
    public void addMigratingInContainerVm(ContainerVmNew containerVm) {
         ...
         * @param vm the vm
         */
        public void removeMigratingInContainerVm(ContainerVmNew vm) {
    ...
    public void reallocateMigratingInContainerVms() {
        for (ContainerVmNew containerVm : getVmsMigratingIn()) {
     ...
     */
    public boolean isSuitableForContainerVm(ContainerVmNew vm) {
     ...
     * @post $none
     */
    public boolean containerVmCreate(ContainerVmNew vm) {
     ...
     * @post $none
     */
    public void containerVmDestroy(ContainerVmNew containerVm) {
     ...
     * @param containerVm the VM
     */
    protected void containerVmDeallocate(ContainerVmNew containerVm) {
     ...
     * @post $none
     */
    public ContainerVmNew getContainerVm(int vmId, int userId) {
     ...
     * @post $none
     */
    public boolean allocatePesForContainerVm(ContainerVmNew containerVm, List<Double> mipsShare) {
     ...
     * @post $none
     */
    public void deallocatePesForContainerVm(ContainerVmNew containerVm) {
     ...
     * @post $none
     */
    public List<Double> getAllocatedMipsForContainerVm(ContainerVmNew containerVm) {
     ...
     */
    public double getTotalAllocatedMipsForContainerVm(ContainerVmNew containerVm) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends ContainerVmNew> List<T> getVmList() {
     ...
     */
    public List<ContainerVmNew> getVmsMigratingIn() {
