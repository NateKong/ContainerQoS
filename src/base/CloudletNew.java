...
public class CloudletNew {
     ...
     * execution history on each VM is registered at {@link CloudletNew#resList}
     */
    ...
    public String getCloudletStatusString() {
        return CloudletNew.getStatusString(status);
    }
    ...
    public static String getStatusString(final int status) {
        ...
        switch (status) {
            case CloudletNew.CREATED:
                statusString = "Created";
                break;

            case CloudletNew.READY:
                statusString = "Ready";
                break;

            case CloudletNew.INEXEC:
                statusString = "InExec";
                break;

            case CloudletNew.SUCCESS:
                statusString = "Success";
                break;

            case CloudletNew.QUEUED:
                statusString = "Queued";
                break;

            case CloudletNew.FAILED:
                statusString = "Failed";
                break;

            case CloudletNew.CANCELED:
                statusString = "Canceled";
                break;

            case CloudletNew.PAUSED:
                statusString = "Paused";
                break;

            case CloudletNew.RESUMED:
                statusString = "Resumed";
                break;

            case CloudletNew.FAILED_RESOURCE_UNAVAILABLE:
